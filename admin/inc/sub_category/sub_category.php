        ...
        <div class="justify-between items-center block md:flex">
            <div class="flex shrink-0 grow-0 items-center justify-center mb-6 md:mb-0">
                <ul>
                    ...
                    <li class="title-stack-item inline-block pr-3 text-2xl text-gray-500 dark:text-gray-400 last:pr-0 last:font-black last:text-black dark:text-gray-100" data-v-fecf18ac="">Sub Category</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="px-0 md:px-6 py-6">
        ...
        <section class="px-6 sm:px-0 mb-6 flex items-center justify-between">
            <div class="flex items-center justify-start"><span class="inline-flex justify-center items-center w-6 h-6 mr-3"><svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                ...
                <h1 class="text-2xl">Sub categories overview</h1>
        ...
        <div class="md:rounded border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800 mb-6">
                        ...
                        <div class="mt-2">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="flex items-center mt-4">
                                    ...
                                    <input type="text" name="sub_cat_name" class="form-control mr-4" placeholder="Enter sub category name">
                                    <button name="add_sub_cat" class="px-4 py-2 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/3">Add sub category</button>
                                </div>
                            </form>
                        </div>
                    </details>
            ...
            <div class="flex flex-col flex-grow mt-4">
                <div class="flex items-center justify-between px-4">
                    <p class="text-2xl font-bold">Manage sub categories</p>
                </div>
                <div class="my-2">
                            ...
                            <table class="divide-y divide-gray-200 min-w-full">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Main</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="text-sm font-medium text-gray-900"> <?php echo $cat['cat_name'] ?> </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="index.php?edit_sub_cat=<?php echo $cat['id'] ?>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <a href="index.php?del_sub_cat=<?php echo $cat['id'] ?>" class="text-red-600 hover:text-red-900 ml-2">Delete</a>
                                            </td>
                                        </tr>
