<nav class="top-0 left-0 right-0 fixed flex bg-white h-14 border-b z-30 w-screen transition-position xl:pl-60 lg:w-auto lg:items-stretch dark:bg-gray-900 dark:border-gray-800 border-gray-100">
    <div class="flex-1 items-stretch flex h-14">
        ...
        <div class="px-3">
            <div class="pt-2 relative text-gray-600">
                <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Search (ctrl+k)">
    ...
    <div class="absolute w-screen top-14 left-0 bg-white shadow lg:w-auto lg:items-stretch lg:flex lg:grow lg:static lg:border-b-0 lg:overflow-visible lg:shadow-none dark:bg-gray-900 hidden">
        <div class="max-h-screen-menu overflow-y-auto lg:overflow-visible lg:flex lg:items-stretch lg:justify-end lg:ml-auto">
            ...
            <div class="flex items-center grow-0 shrink-0 relative cursor-pointer text-blue-600 dark:text-white dark:hover:text-gray-400 hover:text-black py-2 px-3 lg:w-16 lg:justify-center">
                <form action="../../inc/controller/auth_controller.php" method="POST">
                    <button type="submit" name="logout">
                        <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                ...
                <span class="px-2 transition-colors lg:hidden">
                    Logout
                </span>
            </div>
        </div>
