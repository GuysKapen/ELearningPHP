    ...
    <div class="md:rounded border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800 mb-6">
                                ...
                                <div class="mt-2">
                                    <form action="inc/controller/course_controller.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                                        ...
                                        <div class="text-right">
                                            <button name="add_course_video" class="px-4 py-2 mt-4 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Add course</button>
                                        </div>
                                    </form>
                            ...
                            <div class="tab-pane" id="update">
                                <div>
                                    <form action="inc/controller/course_controller.php" method="post" enctype="multipart/form-data" onsubmit="">
                                        ...
                                        <div class="text-right">
                                            <button name="update_course_video" class="px-4 py-2 mt-4 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Update course</button>
                                        </div>
                                    </form>
                            ...
                            <div class="tab-pane" id="delete">
                                <div class="mt-2">
                                    <form action="inc/controller/course_controller.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="text-right">
                                            <button name="del_course_video" class="px-4 py-2 mt-4 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Delete course</button>
                                        </div>
                                    </form>
        ...
        <div class="flex flex-col flex-grow mt-4">
            <div class="flex items-center justify-between px-4">
                <p class="text-2xl font-bold">Manage courses video</p>
            </div>
            <div class="my-2">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <img src="<?php echo '/ELearning/' . $course['course_image'] ?>" class="w-32 object-cover mx-auto" />
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo $course["username"] ?></td>
