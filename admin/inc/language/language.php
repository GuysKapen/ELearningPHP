        ...
        <div class="md:rounded border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800 mb-6">
                        ...
                        <div class="mt-2">
                            <form method="post" enctype="multipart/form-data">
                                <div class="flex items-center">
                                    <input type="text" name="name" class="form-control mr-4" placeholder="Enter language name">
                                    <button name="add_lang" class="px-4 py-2 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Add language</button>
                                </div>
                            </form>
                        </div>
                    </details>
            ...
            <div class="flex flex-col flex-grow mt-4">
                <div class="flex items-center justify-between px-4">
                    <p class="text-2xl font-bold">Manage languages</p>
                </div>
                <div class="my-2">
