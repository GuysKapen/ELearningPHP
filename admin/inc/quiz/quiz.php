    ...
    <div class="justify-between items-center block md:flex">
        <div class="flex shrink-0 grow-0 items-center justify-center mb-6 md:mb-0">
            <ul>
                ...
                <li class="title-stack-item inline-block pr-3 text-2xl text-gray-500 dark:text-gray-400 last:pr-0 last:font-black last:text-black dark:text-gray-100" data-v-fecf18ac="">Quiz</li>
            </ul>
        </div>
    </div>
</section>
...
<section class="px-0 md:px-6 py-6">
    ...
    <section class="px-6 sm:px-0 mb-6 flex items-center justify-between">
        <div class="flex items-center justify-start"><span class="inline-flex justify-center items-center w-6 h-6 mr-3"><svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
            ...
            <h1 class="text-2xl">Quiz overview</h1>
    ...
    <div class="md:rounded border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800 mb-6">
                    ...
                    <div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="add">
                                <div class="mt-2">
                                    <form action="inc/controller/course_quiz_controller.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                                        <div class="form-group">
                                            ...
                                            <div class="form-input mt-1">
                                                <input type="text" class="form-control" id="quiz_name" placeholder="Enter quiz name" name="quiz_name">
                                            </div>
                                        ...
                                        <div class="text-right">
                                            <button name="add_quiz" class="px-4 py-2 mt-4 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Add quiz</button>
                                        </div>
                                    </form>
                            ...
                            <div class="tab-pane" id="update">
                                <div>
                                    <form action="inc/controller/course_quiz_controller.php" method="post" enctype="multipart/form-data" onsubmit="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control mt-1" id="exampleFormControlSelect1" name="selected_quiz">
                                        ...
                                        <div class="text-right">
                                            <button name="update_quiz" class="px-4 py-2 mt-4 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Update quiz</button>
                                        </div>
                                    </form>
                            ...
                            <div class="tab-pane" id="delete">
                                <div class="mt-2">
                                    <form action="inc/controller/course_quiz_controller.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                        <label class="mt-2 text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4 w-1/6 flex-shrink-0" for="exampleFormControlSelect1">
                                                Select quiz
                                            </label>
                                            <select class="form-control mt-1" id="exampleFormControlSelect1" name="quiz_id">
                                        ...
                                        <div class="text-right">
                                            <button name="del_quiz" class="px-4 py-2 mt-4 rounded-full bg-indigo-600 font-bold text-sm text-white w-1/4">Delete quiz</button>
                                        </div>
                                    </form>
        ...
        <div class="flex flex-col flex-grow mt-4">
            <div class="flex items-center justify-between px-4">
                <p class="text-2xl font-bold">Manage quizz</p>
            </div>
            <div class="my-2">
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="text-sm font-medium text-gray-900"> <?php echo $quiz['quiz_name'] ?> </div>
                                            </div>
                                        </td>
