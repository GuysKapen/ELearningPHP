						...
						<div class="row">
							...
							?>
								...
								<div class="card ml-5 mt-4" style="width: 18rem;">
									...
									<div class="card-body">
										<h5 class="card-title"><?php echo $course_list['language_name']; ?> <a href="edit_topics.php?course_name=<?php echo $course_list['language_name']; ?>" class="h6 text-info float-right">Edit <i class="fa fa-pencil ml-1"></i></a></h5>
								...
								<div class="card mt-3 tab-card shadow-lg">
									<div class="card-header tab-card-header">
										<ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
											<li class="nav-item">
												<a class="nav-link section-sub-title" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="One" aria-selected="true">Add</a>
											</li>
											<li class="nav-item">
									...
									<div class="tab-content" id="myTabContent">
										...
										<div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
											...
											<div class="card-body col-md-12">
												...
												<div class="shadow-lg rounded-md overflow-hidden">
													<div class="primary text-light p-2 cardh2">
														<h3 class="section-title m-0">Add new course</h3>
													</div>

													<div class="card-body small p-6">
														<form action=" course_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
															<div class="form-group">
																<label class="font-bold" for="email">Course name :</label>
															...
															<div class="text-right">
																<button type="submit" class="primary-btn" name="btn_add">Submit</button>
															</div>
														</form>
										...
										<div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
											...
											<div class="card-body col-md-12">
												...
												<div class="shadow-lg rounded-md overflow-hidden">
													...
													<div class="card-header primary text-light p-2 cardh2 ">
														<h3 class="section-title m-0">Update course</h3>
													</div>
													...
													<div class="card-body small p-6">
														...
														<form action="course_add.php" method="post" enctype="multipart/form-data" onsubmit="">
															...
															<div class="text-right">
																<button type="submit" class="primary-btn" name="btn_update">Submit</button>
															</div>
														</form>
										...
										<div class="tab-pane fade p-3" id="three" role="tabpanel" aria-labelledby="three-tab">
											...
											<div class="card-body col-md-12">
												...
												<div class="shadow-lg rounded-md overflow-hidden">
													<div class="card-header primary text-light p-2 cardh2">
														<h3 class="section-title m-0">Delete course</h3>
													</div>
													...
													<div class="card-body small p-6">
														<form action=" course_add.php" method="post" enctype="multipart/form-data">
															...
															<div class="text-right">
																<button type="submit" class="primary-btn" name="btn_delete_course">Submit</button>
															</div>
														</form>
